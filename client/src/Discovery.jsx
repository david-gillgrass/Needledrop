...
function Discovery({onSubmit}){
    ...
    <div className="bg-zinc-800 border border-amber-400 rounded-xl p-4 mb-2 flex flex-col md:flex-row items-center gap-3">
        ...
        <label htmlFor="upload" className="bg-zinc-700 hover:bg-zinc-600 text-sm px-4 py-3 rounded-lg cursor-pointer transition-colors whitespace-nowrap gap-2 flex flex-row">
        ...
        <button type="button" 
        className="bg-zinc-700 hover:bg-zinc-600 text-sm px-4 py-3 rounded-lg cursor-pointer transition-colors whitespace-nowrap gap-2 flex flex-row"
        onClick={()=>window.location.href = 'http://127.0.0.1:8000/spotify/login'}
        >
